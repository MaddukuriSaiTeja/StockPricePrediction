...
def predict():
    ...
    def get_historical(quote):
        ...
        start_date = (datetime.today() - timedelta(days=730)).strftime('%Y-%m-%d')  # 2 years back
    ...
    def LIN_REG_ALGO(df):
        ...
        print()
        print("##############################################################################")
        print("Tomorrow's ",quote," Closing Price Prediction by VOTING Regression: ",lr_pred)
        print("VOTING Regression RMSE:",error_lr)
        print("##############################################################################")
    ...
    try:
        ...
        #polarity,tw_list,tw_pol,pos,neg,neutral = retrieving_tweets_polarity(quote) tw_list=tw_list,tw_pol=tw_pol,idea=idea,decision=decision,
        
        #idea, decision=recommending(df, today_stock,mean)#polarity,
        print()
